...
$lang['neutralize']     = 'Apply "neutral" colors from `style.ini` to selected elements (`docInfo` is only concerned when set as standalone).  [default: <code>pagenav,toc,docinfo,side-widgets</code>]';
