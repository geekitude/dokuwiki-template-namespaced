...
$lang['neutralize']         = 'Apply "neutral" colors from `style.ini` to selected elements (`docInfo` is only concerned when set as standalone) except when they are set to transparent (see above). [default: <code>nothing selected</code>]';
$lang['collapsible-toc']    = 'Show or hide ToC content switch. [default: <code>enabled</code>]';
$lang['acordion-toc']       = 'Auto-fold ToC sub-elements untill hovering. [default: <code>disabled</code>]';
